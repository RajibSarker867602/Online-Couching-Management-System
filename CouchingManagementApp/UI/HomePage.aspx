<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="CouchingManagementApp.UI.HomePage" %>
    ...
    <li style="float:right"><a href="LoginPageUI.aspx"><span>Log Out</span></a></li>
		...
		<div class="container">
			<div class="agile-form">
        		<marquee><h1 style="te">Knowledge Gain Training Center</h1></marquee>	
                <h4 style="text-align:center">Gain Knowledge, Gain Skils and Certifed.</h4>			
			</div>
		</div>
	</div>
        </form>
   ...
   <li><a href="FeesPageUI.aspx"><span>Fees</span></a></li>
    ...
    <li style="float:right"><a href="LoginPageUI.aspx"><span>Log Out</span></a></li>
		...
		<div class="container">
			<div class="agile-form">
				<ul class="field-list">
                        <h1>Knowledge Gain Training Center</h1>   
			    </ul>	
			</div>
		</div>
