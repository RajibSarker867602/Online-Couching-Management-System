<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTeacherPageUI.aspx.cs" Inherits="CouchingManagementApp.UI.AddTeacherPageUI" %>
...
<ul>
   ...
   <li><a href="FeesPageUI.aspx"><span>Fees</span></a></li>
    ...
    <li class='active'><a href="AddTeacherPageUI.aspx"><span>Add Teacher</span></a></li>
					...
					<ul class="field-list">
						<li>
							...
							<div class="form-input">
								<asp:TextBox ID="teacherNameTextBox" runat="server" placeholder="Enter Teacher's Name"></asp:TextBox>
							</div>
						</li>
                         <li>
							<label class="form-label"> 
							...
							<div class="form-input">
								<asp:DropDownList ID="courseListDdList" runat="server" ForeColor="#0066FF">
                        ...
                        <li>
							...
							<div class="form-input">
								<asp:TextBox ID="qualificationTextBox" runat="server" placeholder="Enter Teacher's Qualification"></asp:TextBox>
							</div>
						</li>
