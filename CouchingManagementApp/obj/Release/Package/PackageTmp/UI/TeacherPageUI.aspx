<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherPageUI.aspx.cs" Inherits="CouchingManagementApp.UI.TeacherPageUI" %>
...
<ul>
   ...
   <li><a href="FeesPageUI.aspx"><span>Fees</span></a></li>
    ...
    <li class='active'><a href="TeacherPageUI.aspx"><span>Teacher</span></a></li>
   ...
   <%--<li class='last'><a href='#'><span>Contact</span></a></li>--%>
        ...
        <asp:GridView ID="allTeacherGridView" runat="server" HorizontalAlign="Center" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
